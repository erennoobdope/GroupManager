...
You  and also know and i also know that how difficult is to manage any group and if spammers comes also

I'm modular group management bot with cool and normie functions and for spammers too🃏

Activate Anti-spam protection in your BM by this command : 
/antispam on 


Click /help or type /help to bout myself much how to use perfectly 😁.

Add me to a group by clicking  ( http://t.me/ErenDope_Bot?startgroup=true ).
"""
